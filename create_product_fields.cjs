...
fs.mkdirSync('src/merchant/settings/product_fields/models', { recursive: true });
fs.mkdirSync('src/merchant/settings/product_fields/services', { recursive: true });
fs.mkdirSync('src/merchant/settings/product_fields/screens', { recursive: true });

// 1. Model
fs.writeFileSync('src/merchant/settings/product_fields/models/ProductFieldSettings.ts', `
export interface ProductFieldSettings {
...
// 2. Service
fs.writeFileSync('src/merchant/settings/product_fields/services/productFieldsService.ts', `
...
`;
fs.writeFileSync('src/merchant/settings/product_fields/screens/ProductFieldsSettingsScreen.tsx', screenCode);
console.log('Product fields logic created.');
